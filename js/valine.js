...
*/
    ...
    o.prototype.Q = function (e) {
      ...
      o.prototype.bind = function () {
        ...
        var C = function (t, n, r) {
          ...
          // var u = T.hide ? '' : e.config.enableQQ && t.get('QQAvatar') ? '<img class="vimg" src="' + t.get('QQAvatar') + '" referrerPolicy="no-referrer"/>' :
          ...
          var u = T.hide ? '' : e.config.enableQQ && t.get('QQAvatar') ? '<img class="vimg" src="' + t.get('QQAvatar') + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (qq_img) + '">';
  ...
  function (e, t, n) {
    ...
    t.__esModule = !0,
      t.default = function (e, t) {
        if (e.$el && e.$loading.hide().$nodata.hide(), {}.toString.call(t) === '[object Error]') {
